...
player={
  ...
  update=function(this)
    ...
    if levels[lvl_id+1] then
        -- top exit
        if this.y<-4 and lvl_exit_type == 0 then
            next_level()
        end
        -- right exit
        if this.x > lvl_pw and lvl_exit_type == 1 then
            next_level()
        end
        -- left exit
        if this.x<-4 and lvl_exit_type == 2 then
            next_level()
        end
        -- bottom exit
        if this.y > lvl_ph then
            if lvl_exit_type == 3 then
                next_level()
            else
                kill_player(this)
            end
  ...
  draw=function(this)
    ...
    if lvl_exit_type == 0 then
        bound_t = -100
    elseif lvl_exit_type == 1 then
        bound_r = lvl_pw+100
    elseif lvl_exit_type == 2 then
        bound_l = -100
    elseif lvl_exit_type == 3 then
        bound_b = lvl_ph+100
    end
...
levels={
  "0,0,1,1,top exit,0",
  "1,0,1,1,right exit,1",
  "0,1,1,1,left exit,2",
  "1,1,1,1,bottom exit,3",
  "2,0,1,1,summit,4"
}
...
mapdata={
  "",
  "",
  "",
  "",
  ""
}
...
local __init = _init function _init() __init() begin_game() load_level(1) music(-1) max_djump=2 end
--@end
