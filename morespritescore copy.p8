...
levels={
  ...
  "6,1,1,1,,0",
  "7,1,1,1,,1",
  "0,0,2,2,now using base levels,0",
  "2,0,2,2,why are you still here,0",
  "4,0,2,2,secret plans for p10x,0",
  "6,0,2,2,the size of a normal celeste map now,0",
  "0,2,2,2,ice blocks are typically not used and can be deleted to free space,0",
  "2,2,2,2,right exitalie,1",
  "4,2,2,2,who came up with shared memory anyway,0"
}

--mapdata string table
--assigned levels will load from here instead of the map
mapdata={
  [17] = "",
...
function replace_mapdata(x,y,w,h,data)
  ...
  for i=1,#newdata do
    mset(x+((i-1)%w),y+(i-1)/w,ord(sub(newdata,i,i))-1)
  end
end
...
__map__

